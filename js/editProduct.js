function control() {
  ...
  let url = "http://localhost:8133/api/findProduct";
  let url2 = 'http://localhost:8133/api/getProductsCategorias';
  let url3 = 'http://localhost:8133/api/getCategorias';
...
function borrar(n){
  if(confirm("Seguro que quieres borrar el producto #"+n)){
    let url = "http://localhost:8133/api/deleteProduct";
...
function guardarUnProd(){
  ...
  let url = "http://localhost:8133/api/updateProduct";
  ...
  let url2 = 'http://localhost:8133/api/getProductsCategorias';
  let url22 = 'http://localhost:8133/api/deleteCategoriaProducto';
  ...
  let url3 = "http://localhost:8133/api/createCategoriaProducto";
